...
class Reacher3DEnv_wall(mujoco_env.MujocoEnv, utils.EzPickle):
    def __init__(self):
        self.viewer = None
        ...
        mujoco_env.MujocoEnv.__init__(self, os.path.join(dir_path, 'assets/reacher3d_3wall.xml'), 2)
